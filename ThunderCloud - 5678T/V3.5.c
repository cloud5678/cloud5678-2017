...
//auto methods
void drive(int speed, int forHowLong)//Some of these might need to be made negative
{
	do
	{
...
task autonomous()
{
	...
	drive(0, 0);
	wait1Msec(10);
	/*moveMotorTarget(armL3, 197, 127, true);// lift arm a bit
	moveMotorTarget(armR3, -197, 127, true);
